  ...
  return (
    <div className="min-h-screen bg-white dark:bg-convrt-dark-blue">
      <div className="container mx-auto px-4 py-8 md:py-16 max-w-7xl">
        ...
        >
          {currentStep === 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 max-w-[900px] mx-auto">
            ...
            <div className="space-y-12">
              <TooltipProvider>
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5 }}
                  className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden w-full"
                >
                  <Calendar
                    mode="single"
                    selected={date}
